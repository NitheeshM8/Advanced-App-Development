            ...
            {slides.map((slide, index) => (
                <div key={index} className={index === currentSlideIndex ? 'slide active' : 'slide'}>
                    ...
                    <div className="home-box">
                        <h1 className='text12'>Discover,Customize&Book</h1>
                        <p>Discover Top Online Platform for booking boat houses which offering seamless booking experience and unbeatable prices!</p>
